...
export default function Projects() {
  return (
    <Section className="px-12 sm:px-12 lg:max-w-4xl flex flex-col items-center max-md:max-w-lg">
      ...
      <Carousel
        ...
        <CarouselContent className="">
          {PROJECTS.filter((project) => !project.hidden && project.highlighted).map(
            (project, index) => (
